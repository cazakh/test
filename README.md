...
Копируем предыдущую ЛР и будем работать с ней
  
## Part 1

Файлы сценариев для GitHub Actions должны находиться в .`github/workflows`

Создадим файл сценария для Linux - Linux.yml:
```sh
name: CMake
...
Теперь создадим файл сценария для Windows - Windows.yml:
```sh
name: CMake
